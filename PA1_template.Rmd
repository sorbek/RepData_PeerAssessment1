...
Imputing data for missing **step** values provided us with **`r length(steps_per_day_imputed$date) - length(steps_per_day$date)`** additional days for the imputed data histogram.
